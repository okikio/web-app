(function (factory) {
  ...
  */
  ...
  if (!(TO_PRIMITIVE$1 in DatePrototype)) hide(DatePrototype, TO_PRIMITIVE$1, dateToPrimitive);
  ...
  _export({
    ...
    cbrt: function cbrt(x) {
      return mathSign(x = +x) * pow(abs(x), 1 / 3);
    }
  });
  ...
  _export({
    ...
    sinh: function sinh(x) {
      return abs$4(x = +x) < 1 ? (mathExpm1(x) - mathExpm1(-x)) / 2 : (exp$1(x - 1) - exp$1(-x - 1)) * (E$1 / 2);
    }
  });
  ...
  var abs$5 = Math.abs; // `Number.isSafeInteger` method
  ...
  var FORCED$b = descriptors && isForced_1('RegExp', !CORRECT_NEW || fails(function () {
  ...
  var FORCED$c = forcedStringTrimMethod('trimEnd');
  ...
  var FORCED$d = forcedStringTrimMethod('trimStart');
  ...
  var $forEach$2 = arrayIteration.forEach; // `Array.prototype.forEach` method implementation
  // https://tc39.github.io/ecma262/#sec-array.prototype.foreach
  ...
  var FORCED$h = !global_1.setImmediate || !global_1.clearImmediate; // http://w3c.github.io/setImmediate/
  ...
  var _fnval = function _fnval(fn, args, ctxt) {
    ...
    if (_is.not("fn", fn) || keys$3(fn.prototype || {}).length > 0) {
      return fn;
    }
  ...
  props = keys$3(props).reduce(function (acc, i) {
  ...
  var _create = function _create() {
    ...
    if (_is.fn(args[0]) && keys$3(args[0].prototype || {}).length) {
      parent = args.shift();
    } // Class Object
  ...
  var _event = _class({
    ...
    on: function on(evt, callback, scope) {
      ...
      keys$4(evt).forEach(function (key) {
        $evt = evt[key];
  ...
  Ele = _event.extend(arrProto, {
    ...
    on: function on($super, evt, callback, scope) {
      ...
      _evt = _is.obj(evt) && _is.not("arr", evt) ? keys$3(evt) : evt;
    ...
    off: function off($super, evt, callback, scope) {
      ...
      _evt = (_is.obj(evt) && _is.not("arr", evt) ? keys$3(evt) : evt).join(" ");
      this.forEach(function (el, i) {
        $super(evt, callback, scope || el);
