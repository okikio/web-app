(function (factory) {
  ...
  */
  ...
  var wellKnownSymbol = function wellKnownSymbol(name) {
    return store[name] || (store[name] = nativeSymbol && _Symbol[name] || (nativeSymbol ? _Symbol : uid)('Symbol.' + name));
  };
  ...
  var es_function_name = /*#__PURE__*/Object.freeze({
  ...
  var es_string_match = /*#__PURE__*/Object.freeze({
  ...
  var es_string_replace = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_string_search = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_string_split = /*#__PURE__*/Object.freeze({
  ...
  var es_regexp_exec = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_regexp_flags = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_regexp_toString = /*#__PURE__*/Object.freeze({
  ...
  var es_number_constructor = /*#__PURE__*/Object.freeze({
  ...
  var es_date_toString = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_date_toPrimitive = /*#__PURE__*/Object.freeze({
  ...
  var es_arrayBuffer_constructor = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_arrayBuffer_isView = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_arrayBuffer_slice = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_dataView = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_int8Array = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_uint8Array = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_uint8ClampedArray = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_int16Array = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_uint16Array = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_int32Array = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_uint32Array = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_float32Array = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_float64Array = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_from = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_of = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_copyWithin = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_every = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_fill = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_filter = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_find = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_findIndex = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_forEach = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_includes = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_indexOf = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_iterator = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_join = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_lastIndexOf = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_map = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_reduce = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_reduceRight = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_reverse = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_set = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_slice = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_some = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_sort = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_subarray = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_toLocaleString = /*#__PURE__*/Object.freeze({

  });

  // empty

  var es_typedArray_toString = /*#__PURE__*/Object.freeze({
  ...
  var getOwnPropertyDescriptor$5 = objectGetOwnPropertyDescriptor.f; // `Reflect.deleteProperty` method
  ...
  getCjsExportFromNamespace(es_function_name);

  getCjsExportFromNamespace(es_string_match);

  getCjsExportFromNamespace(es_string_replace);

  getCjsExportFromNamespace(es_string_search);

  getCjsExportFromNamespace(es_string_split);

  getCjsExportFromNamespace(es_regexp_exec);

  getCjsExportFromNamespace(es_regexp_flags);

  getCjsExportFromNamespace(es_regexp_toString);

  getCjsExportFromNamespace(es_number_constructor);

  getCjsExportFromNamespace(es_date_toString);

  getCjsExportFromNamespace(es_date_toPrimitive);

  getCjsExportFromNamespace(es_arrayBuffer_constructor);

  getCjsExportFromNamespace(es_arrayBuffer_isView);

  getCjsExportFromNamespace(es_arrayBuffer_slice);

  getCjsExportFromNamespace(es_dataView);

  getCjsExportFromNamespace(es_typedArray_int8Array);

  getCjsExportFromNamespace(es_typedArray_uint8Array);

  getCjsExportFromNamespace(es_typedArray_uint8ClampedArray);

  getCjsExportFromNamespace(es_typedArray_int16Array);

  getCjsExportFromNamespace(es_typedArray_uint16Array);

  getCjsExportFromNamespace(es_typedArray_int32Array);

  getCjsExportFromNamespace(es_typedArray_uint32Array);

  getCjsExportFromNamespace(es_typedArray_float32Array);

  getCjsExportFromNamespace(es_typedArray_float64Array);

  getCjsExportFromNamespace(es_typedArray_from);

  getCjsExportFromNamespace(es_typedArray_of);

  getCjsExportFromNamespace(es_typedArray_copyWithin);

  getCjsExportFromNamespace(es_typedArray_every);

  getCjsExportFromNamespace(es_typedArray_fill);

  getCjsExportFromNamespace(es_typedArray_filter);

  getCjsExportFromNamespace(es_typedArray_find);

  getCjsExportFromNamespace(es_typedArray_findIndex);

  getCjsExportFromNamespace(es_typedArray_forEach);

  getCjsExportFromNamespace(es_typedArray_includes);

  getCjsExportFromNamespace(es_typedArray_indexOf);

  getCjsExportFromNamespace(es_typedArray_iterator);

  getCjsExportFromNamespace(es_typedArray_join);

  getCjsExportFromNamespace(es_typedArray_lastIndexOf);

  getCjsExportFromNamespace(es_typedArray_map);

  getCjsExportFromNamespace(es_typedArray_reduce);

  getCjsExportFromNamespace(es_typedArray_reduceRight);

  getCjsExportFromNamespace(es_typedArray_reverse);

  getCjsExportFromNamespace(es_typedArray_set);

  getCjsExportFromNamespace(es_typedArray_slice);

  getCjsExportFromNamespace(es_typedArray_some);

  getCjsExportFromNamespace(es_typedArray_sort);

  getCjsExportFromNamespace(es_typedArray_subarray);

  getCjsExportFromNamespace(es_typedArray_toLocaleString);

  getCjsExportFromNamespace(es_typedArray_toString);
  ...
  var esnext_array_lastIndex = /*#__PURE__*/Object.freeze({

  });

  // empty

  var esnext_array_lastItem = /*#__PURE__*/Object.freeze({

  });

  getCjsExportFromNamespace(esnext_array_lastIndex);

  getCjsExportFromNamespace(esnext_array_lastItem);
  ...
  var min$7 = Math.min;
  var max$3 = Math.max; // `Math.clamp` method
  ...
  var web_domCollections_forEach = /*#__PURE__*/Object.freeze({
  ...
  var FORCED$f = !global_1.setImmediate || !global_1.clearImmediate; // http://w3c.github.io/setImmediate/
  ...
  getCjsExportFromNamespace(web_domCollections_forEach);
  ...
  var _fnval = function _fnval(fn, args, ctxt) {
    ...
    if (_is.not("fn", fn) || keys$1(fn.prototype || {}).length > 0) {
      return fn;
    }
  ...
  props = keys$1(props).reduce(function (acc, i) {
  ...
  var _create = function _create() {
    ...
    if (_is.fn(args[0]) && keys$1(args[0].prototype || {}).length) {
      parent = args.shift();
    } // Class Object
  ...
  var _event = _class({
    ...
    on: function on(evt, callback, scope) {
      ...
      keys$2(evt).forEach(function (key) {
        $evt = evt[key];
  ...
  Ele = _event.extend(arrProto, {
    ...
    on: function on($super, evt, callback, scope) {
      ...
      _evt = _is.obj(evt) && _is.not("arr", evt) ? keys$1(evt) : evt;
    ...
    off: function off($super, evt, callback, scope) {
      ...
      _evt = (_is.obj(evt) && _is.not("arr", evt) ? keys$1(evt) : evt).join(" ");
      this.forEach(function (el, i) {
        $super(evt, callback, scope || el);
