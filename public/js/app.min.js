(function (factory) {
	...
	*/
	...
	var _stringify = function _stringify(obj) {
	  var fns = [];
	  var json = stringify$1(obj, function (key, val) {
	...
	Ele = _event.extend(arrProto, {
	  init: function init($super) {
	    var sel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
	    var ctxt = arguments.length > 2 ? arguments[2] : undefined;
	    $super();
