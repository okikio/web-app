(function (factory) {
  ...
  */
  ...
  var FORCED$1 = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || SLOPPY_METHOD$3; // `Array.prototype.sort` method
  ...
  var sqrt = Math.sqrt;
  var LN2 = Math.LN2;
  var FORCED$3 = !nativeAcosh // V8 bug: https://code.google.com/p/v8/issues/detail?id=3509
  ...
  _export({
    ...
    acosh: function acosh(x) {
      return (x = +x) < 1 ? NaN : x > 94906265.62425156 ? log$1(x) + LN2 : mathLog1p(x - 1 + sqrt(x - 1) * sqrt(x + 1));
    }
  });
  ...
  var log$3 = Math.log; // `Math.atanh` method
  ...
  var hex = /^[+-]?0[Xx]/;
  var FORCED$7 = nativeParseInt(whitespaces + '08') !== 8 || nativeParseInt(whitespaces + '0x16') !== 22; // `parseInt` method
  ...
  var FORCED$9 = !descriptors || FAILS_ON_PRIMITIVES$1; // `Object.getOwnPropertyDescriptor` method
  // https://tc39.github.io/ecma262/#sec-object.getownpropertydescriptor
  ...
  var test$2 = {};
  test$2[TO_STRING_TAG$3] = 'z'; // `Object.prototype.toString` method implementation
  ...
  var FORCED$c = descriptors && isForced_1('RegExp', !CORRECT_NEW || fails(function () {
  ...
  var FORCED$d = forcedStringTrimMethod('trimEnd');
  ...
  var FORCED$e = forcedStringTrimMethod('trimStart');
  ...
  var aTypedArrayConstructor$4 = arrayBufferViewCore.aTypedArrayConstructor; // `%TypedArray%.of` method
  ...
  var defineProperty$8 = objectDefineProperty.f; // `Array.prototype.lastIndex` getter
  ...
  var defineProperty$9 = objectDefineProperty.f; // `Array.prototype.lastIndex` accessor
  // https://github.com/keithamus/proposal-array-last
  ...
  var Subscription = function Subscription(observer, subscriber) {
    var subscriptionState = setInternalState$7(this, {
      cleanup: undefined,
  ...
  var getInternalState$6 = internalState.getterFor(STRING_ITERATOR$1); // TODO: unify with String#@@iterator
  ...
  _export({
   ...
   MATCH_ALL in RegExpPrototype$2 || hide(RegExpPrototype$2, MATCH_ALL, $matchAll);
  ...
  var FORCED$i = !global_1.setImmediate || !global_1.clearImmediate; // http://w3c.github.io/setImmediate/
  ...
  /* , base */
    ...
    var state = setInternalState$b(that, {
      type: 'URL'
    });
...
//# sourceMappingURL=/maps/polyfill.min.js.map
